...
var OFF_TOPIC_NOTICES = [
  ...
  '排队提醒：当前窗口仅办理取号、补号和忘记自己为什么取号三类业务，其余情况请明天再想。',
  '自助机提示：如屏幕长时间无响应，请先确认自己是否也长时间无响应，再呼叫工作人员。',
  '餐厅告示：本店米饭免费续一次，情绪不提供续杯。如需加量，请到前台说明具体原因。',
  '快递柜通知：您的物品已超时滞留，柜门暂不愿意打开，请您与它协商后再试。',
  '楼道提示：请勿在公共区域堆放杂物、旧情绪及无法分类的临时结论。',
  '打印店通知：黑白单面一元一张，彩色另计。内容过于自由的文件请自行承担装订后果。'
]
...
var LOW_KEY_OFF_TOPIC = [
  ...
  '今天买酸奶吸管没有掉进袋子最底下，我一路都保持了基本尊严。',
  '我刚把付款码一次打开，没有误触健康码。这个稳定性值得内部表扬。',
  '刚才洗手液按出来的量刚好够用，没有多也没有少，事情已经很圆满。',
  '我今天坐电梯没有按错楼层，虽然没人鼓掌，但我知道这不容易。',
  '刚把塑料袋一次撑开成功，没有用嘴帮忙，文明程度暂时领先昨天。',
  '我把耳机盒找到了，耳机也在里面。这个结局比很多关系都完整。'
]
...
var PERSON_FALLBACK_LINES = [
  ...
  '{S}我先按临时材料收下，正式版本请盖章后再寄。',
  '{S}请补一份手写说明，说明为什么这句话看起来像本人自愿发出的。',
  '{S}已进入待确认区，目前和三个可疑标点一起排队。',
  '{S}我读完了，建议你把这句话拿去打印店塑封，方便以后举证。',
  '{S}不支持口头撤回，除非你能证明刚才打字的是手指自主行为。',
  '{S}需要拆成主谓宾重新入库，现在这一坨系统不认。'
]
...
var CRUSH_FALLBACK_LINES = [
  ...
  '{S}，我本来想装没看懂，但你这句太像在等我接话。',
  '你把{S}发出来之前，是不是已经给我留了一个台阶？我先站上去。',
  '{S}我先不拆。拆开就像我太会了，留一点给你发挥。',
  '这句{S}我读得很克制了，再读一遍就容易偏向你。',
  '{S}，我可以按字面回，也可以按你想让我懂的那个意思回。你选一个。'
]
